...
//_____________________________________ J'ai directement mis mes fonctions ici pour éviter les conflits dans mon .c
...
void plateau(int tableau[taille_t][taille_t]);
void jeu(int tableau[taille_t][taille_t]);
void jeu_solo(int tableau[taille_t][taille_t]);
void jeu_automate(int tableau[taille_t][taille_t]);
